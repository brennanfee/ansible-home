...
#
# Short URL: https://tinyurl.com/brennan-vm-home-lab-config
# Github URL: https://raw.githubusercontent.com/brennanfee/ansible-home/refs/heads/main/deb-bootstrap-configs/vm-home-lab.bash
#
...
# For VM machines, I do not want the disks encrypted, the underlying server should have encrypted storage
...
export AUTO_DOMAIN="lab.bfee.casa"

# User setup
# TODO: Create different SSH keys for LAB instances
